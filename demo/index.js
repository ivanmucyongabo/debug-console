...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    class LogRegistryItem {
        ...
        unsubscribe(fn) {
            __classPrivateFieldSet(this, _LogRegistryItem_handlers, __classPrivateFieldGet(this, _LogRegistryItem_handlers, "f").filter(function (item) {
                if (item !== fn) {
                    return item;
                }
            }), "f");
    ...
    class Component {
        ...
        html() {
            if (this.element) {
                ...
                let el = document.createElement(__classPrivateFieldGet(this, _Component_tagName_, "f"));
    ...
    class Counter extends Component {
        ...
        setCount(count) {
            let el = this.element;
            if (el) {
                let countEl = document.getElementById(`${__classPrivateFieldGet(this, _Counter_countId_, "f")}`);
                countEl.innerText = count.toString();
            }
        }
        increment(delta) {
            let oldCount = __classPrivateFieldGet(this, _Counter_count_, "f");
    ...
    class ToolBar extends Component {
        ...
        renderAsHTML() {
            let html = super.renderAsHTML();
            let itemsCopy = __classPrivateFieldGet(this, _ToolBar_items_, "f");
    ...
    var _Formatter_timer, _Formatter_showAbsoluteTime, _Formatter_showRelativeTime, _Formatter_showLoggerName, _Formatter_showSeverityLevel, _Formatter_css, _Formatter_prefix;
    ...
    class Formatter {
        constructor(css, opt_prefix) {
            ...
            _Formatter_css.set(this, void 0);
            _Formatter_prefix.set(this, void 0);
            __classPrivateFieldSet(this, _Formatter_timer, new Timer(), "f");
            __classPrivateFieldSet(this, _Formatter_showAbsoluteTime, true, "f");
            __classPrivateFieldSet(this, _Formatter_showRelativeTime, true, "f");
            __classPrivateFieldSet(this, _Formatter_showLoggerName, true, "f");
            __classPrivateFieldSet(this, _Formatter_showSeverityLevel, false, "f");
            __classPrivateFieldSet(this, _Formatter_css, css || Object.create(DEFAULT_CSS), "f");
            __classPrivateFieldSet(this, _Formatter_prefix, opt_prefix || '', "f");
        }
        get timer() {
        ...
        get css() {
            return __classPrivateFieldGet(this, _Formatter_css, "f");
        }
        set css(css) {
            __classPrivateFieldSet(this, _Formatter_css, css, "f");
        }
        static getDateTimeStamp(logRecord) {
        ...
        static getRelativeTime(logRecord, timestamp) {
        ...
        formatAsHtml(logRecord) {
            ...
            var sb = [];
            sb.push(__classPrivateFieldGet(this, _Formatter_prefix, "f"), ' ');
            if (this.showAbsoluteTime) {
                sb.push('[', Formatter.getDateTimeStamp(logRecord), '] ');
            }
            if (this.showRelativeTime) {
                sb.push('[', Formatter.getRelativeTime(logRecord, __classPrivateFieldGet(this, _Formatter_timer, "f").timestamp), 's] ');
            }
    ...
    _Formatter_timer = new WeakMap(), _Formatter_showAbsoluteTime = new WeakMap(), _Formatter_showRelativeTime = new WeakMap(), _Formatter_showLoggerName = new WeakMap(), _Formatter_showSeverityLevel = new WeakMap(), _Formatter_css = new WeakMap(), _Formatter_prefix = new WeakMap();
    ...
    class DebugConsole extends Component {
        ...
        log(logRecord) {
            ...
            let scroll = (__classPrivateFieldGet(this, _DebugConsole_logEl_, "f").scrollHeight - __classPrivateFieldGet(this, _DebugConsole_logEl_, "f").scrollTop - __classPrivateFieldGet(this, _DebugConsole_logEl_, "f").clientHeight) <= 100;
        ...
        clear() {
            var _a;
            __classPrivateFieldGet(this, _DebugConsole_logEl_, "f").innerHTML = "";
        ...
        render() {
            ...
            if (__classPrivateFieldGet(this, _DebugConsole_mountTo, "f") && (typeof __classPrivateFieldGet(this, _DebugConsole_mountTo, "f") === 'string')) {
                let target = document.getElementById(__classPrivateFieldGet(this, _DebugConsole_mountTo, "f"));
        ...
        renderAsHTML() {
            ...
            headerEl.append(__classPrivateFieldGet(this, _DebugConsole_toolbar_, "f").renderAsHTML());
    ...
    const subscribe = (logger, fn) => {
        if (logger) {
            ...
            let loggerItem = getLogger(logger);
    ...
    const log = (logger, level, msg) => {
        if (logger) {
            ...
            let loggerItem = getLogger(logger);
            let logRecord = logBuffer.add(level, msg, logger);
