...
class Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _Component_uuid_, uniqueId(), "f");
        __classPrivateFieldSet(this, _Component_id_, config.id || (camelCase(this.constructor.name) + __classPrivateFieldGet(this, _Component_uuid_, "f")), "f");
        ...
        __classPrivateFieldSet(this, _Component_classNames_, union(config.classNames || [], [this.name]), "f");
    }
    get id() {
...
class Button extends Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _Button_labelClassNames_, union(config.labelClassNames || [], [`${this.name}${DEFAULT_SEPERATOR$4}label`]), "f");
        __classPrivateFieldSet(this, _Button_iconClassNames_, union(config.iconclassNames || [], [`${this.name}${DEFAULT_SEPERATOR$4}icon`]), "f");
    }
    get label() {
...
class Accordian extends Button {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _Accordian_panelClassNames_, union(config.panelClassNames || [], []), "f");
    }
    render() {
...
class ComboBox extends Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _ComboBox_inputClassNames_, union(config.inputClasses || [], [`${this.name}${DEFAULT_SEPERATOR$3}input`]), "f");
        __classPrivateFieldSet(this, _ComboBox_btnClassNames_, union(config.btnClasses || [], [`${this.name}${DEFAULT_SEPERATOR$3}button`]), "f");
        __classPrivateFieldSet(this, _ComboBox_listBoxClassNames_, union(config.listBoxClasses || [], [`${this.name}${DEFAULT_SEPERATOR$3}listbox`]), "f");
        __classPrivateFieldSet(this, _ComboBox_listBoxItemClassNames_, union(config.listBoxItemClassNames || [], [`${this.name}${DEFAULT_SEPERATOR$3}listbox${DEFAULT_SEPERATOR$3}item`]), "f");
        __classPrivateFieldSet(this, _ComboBox_containerClassNames_, union(config.containerClassNames || [], [`${this.name}${DEFAULT_SEPERATOR$3}group`]), "f");
        this.classNames = union(config.wrapperClassNames || [], this.classNames, [this.name, `${this.name}${DEFAULT_SEPERATOR$3}list`]);
    }
    get filter() {
...
class Counter extends Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _Counter_countClassNames_, union(config.countClassNames || [], [`${this.name}${DEFAULT_SEPERATOR$2}count`]), "f");
        this.classNames = union(this.classNames, [this.name]);
    }
    get count() {
...
class ToolBar extends Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _ToolBar_itemClassNames_, union(config.itemClassNames || [], [`${this.name}${DEFAULT_SEPERATOR$1}item`]), "f");
        __classPrivateFieldSet(this, _ToolBar_groupClassNames_, union(config.groupClassNames || [], [`${this.name}-group`, 'group']), "f");
        this.classNames = union(this.classNames, [this.name]);
...
class DebugConsole extends Component {
    constructor(config) {
        ...
        __classPrivateFieldSet(this, _DebugConsole_headerClassNames_, union(config.headerClassNames || [], [`${this.name}${DEFAULT_SEPERATOR}header`]), "f");
        __classPrivateFieldSet(this, _DebugConsole_logClassNames_, union(config.logClassNames || [], [`${this.name}${DEFAULT_SEPERATOR}logger`]), "f");
        __classPrivateFieldSet(this, _DebugConsole_footerClassNames_, union(config.footerClassNames || [], [`${this.name}${DEFAULT_SEPERATOR}footer`]), "f");
...
export { Accordian, Button, ComboBox, Counter, DebugConsole, Formatter, ToolBar, ToolBarAccordian, ToolBarButton, ToolBarComboBox, ToolBarCounter, debug, error, getLogger, getLoggers, info, log, logBuffer, logRegistry, subscribe, unsubscribe, warning };
